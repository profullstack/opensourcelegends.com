// HTML/CSS card template for "Gods of AI" (Series Four).
// Same bones as the other decks (Series One/Two/Three templates) so all four (Series
...
// Warmer than the Series Three palette: kiln and filament tones rather than
// steel. This set is about things being built, not defended.
const PALETTE = ['e0894a', 'cf5f7a', '9b6bff', '38b6a0', 'e0b23a', '5b8cf0', 'c76bd6', '4fae7a'];
...
// Series Four mark: the same shield as the other decks, holding a three-node
// graph — the smallest thing that is recognisably a network.
const emblem = (a, s = 24) =>
...
export function buildFront(pro, portraitDataUri, ref) {
  ...
  <div class="card">
    ...
    <div class="crestbox"><span class="crest">${emblem(accent, 24)}<span class="t">GODS<br>OF AI</span></span></div>
